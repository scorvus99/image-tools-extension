...
.
├── icons/ # Иконки сервисов и расширения (16, 48, 128 px)
├── manifest.json # Манифест расширения (Manifest V3, Firefox)
├── background.js # Фоновый скрипт: контекстное меню, управление вкладками, загрузка
